...
<div className="cl5123">
	...
	<div className="nvmn1">Main</div>
	
	<div className="right">
			
			<div className="nvmn1112" id="S123">
			...
			<div><img className="brdr50" src="/pics/d281cf9550d6abc5e3824f6b55e57983.jpg" height="40" width="40"/></div>
...
<div class="Lmenu_2">
		...
		<div class="lmenuTitle crz21" >Site menu</div>
		
		
		
		<div class="lmenusub">
			
		<div class=""><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="25" width="25" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"></path></svg>  Dashboard</div>
		...
		<div class=""><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="25" width="25" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M3 3h8v8H3V3zm0 10h8v8H3v-8zM13 3h8v8h-8V3zm0 10h8v8h-8v-8z"></path></g></svg> Fun page</div>
